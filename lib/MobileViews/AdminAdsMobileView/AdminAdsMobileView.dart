...
class AdminAdsMobileView extends StatefulWidget {
  const AdminAdsMobileView({Key? key}) : super(key: key);

  @override
  _AdminAdsMobileViewState createState() => _AdminAdsMobileViewState();
}

class _AdminAdsMobileViewState extends State<AdminAdsMobileView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 2,
        title: Text('إدارة الإعلانات', style: TextStyle(
          fontSize: 18.sp, 
          fontFamily: AppTextStyles.tajawal,
