...
import 'package:tappuu_dashboard/controllers/ColorAndCurrencyController.dart';
...
class ColorAndCurrencyViewMobile extends StatefulWidget {
  const ColorAndCurrencyViewMobile({Key? key}) : super(key: key);

  @override
  _ColorAndCurrencyViewMobileState createState() => _ColorAndCurrencyViewMobileState();
}

class _ColorAndCurrencyViewMobileState extends State<ColorAndCurrencyViewMobile> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 24.h),
              _buildTextField('اسم العملة', Icons.text_fields, _currencyNameController, isDark),
              SizedBox(height: 16.h),
              _buildTextField('رمز العملة', Icons.code, _currencyCodeController, isDark,
                  hintText: 'USD'),
              SizedBox(height: 16.h),
              _buildTextField('الرمز المعروض', Icons.code, _currencySymbolController, isDark,
                  hintText: '\$'),
              SizedBox(height: 16.h),
              _buildTextField('سعر الصرف', Icons.attach_money, _currencyRateController, isDark,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('إدارة الألوان والعملات', 
          style: TextStyle(
            fontSize: 16.sp,
            fontFamily: AppTextStyles.tajawal,
          )
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // يمكن إضافة قائمة منبثقة هنا للاختيار بين إضافة لون أو عملة
              _showAddOptions();
            },
            tooltip: 'إضافة جديد',
          ),
          ...
          children: [
            Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(
                    icon: Icon(Icons.color_lens, size: 20.r),
                    text: 'الألوان',
                  ),
                  Tab(
                    icon: Icon(Icons.currency_exchange, size: 20.r),
                    text: 'العملات',
                  ),
                ],
              ),
            ...
            Expanded(
              child: TabBarView(
                children: [
                  // تبويب الألوان
                  _buildColorsTab(isDark),
                  // تبويب العملات
                  _buildCurrenciesTab(isDark),
                ],
              ),
            ),
          ],
  ...
  Widget _buildColorsTab(bool isDark) {
    return Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(color.hexCode, style: TextStyle(
                            fontSize:12.sp, fontFamily: AppTextStyles.tajawal,
                            color: AppColors.textSecondary(isDark),
                          )),
                          SizedBox(height: 8.h),
  ...
  Widget _buildCurrenciesTab(bool isDark) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 16.h),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('${currency['name']} (${currency['code']})', style: TextStyle(
                                fontSize:16.sp, fontFamily: AppTextStyles.tajawal,
                                fontWeight: FontWeight.bold,
                                color: AppColors.textPrimary(isDark),
                              )),
                              _buildBaseCurrencyBadge(isBase),
                            ],
                          ),
                          SizedBox(height: 8.h),
                            ...
                            children: [
                              if (!isBase) Expanded(
                                child: ElevatedButton.icon(
                                  ...
                                  label: Text('أساسية', style: TextStyle(fontSize: 12.sp)),
                                  onPressed: () {
                                    final id = currency['id'] ?? currency['code'];
      ...
      builder: (context) {
        return SafeArea(
          child: Column(
            ...
            children: [
              ListTile(
                leading: Icon(Icons.color_lens, size: 24.r, color: AppColors.primary),
                title: Text('إضافة لون جديد', style: TextStyle(
                  fontSize: 16.sp,
                  fontFamily: AppTextStyles.tajawal,
                )),
                onTap: () {
              ...
              ListTile(
                leading: Icon(Icons.currency_exchange, size: 24.r, color: AppColors.primary),
                title: Text('إضافة عملة جديدة', style: TextStyle(
                  fontSize: 16.sp,
                  fontFamily: AppTextStyles.tajawal,
                )),
                onTap: () {
