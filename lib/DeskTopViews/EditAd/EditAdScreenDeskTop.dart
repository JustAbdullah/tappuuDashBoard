...
import 'package:tappuu_dashboard/core/data/model/AttributeEdits.dart';
...
class _EditAdScreenDeskTopState extends State<EditAdScreenDeskTop> {
  ...
  Widget _buildAttributeField(AttributeEdit attribute, bool isDark) {
  ...
  Widget _buildAttributeInput(AttributeEdit attribute, bool isDark) {
  ...
  Widget _buildNumberField(AttributeEdit attribute, bool isDark) {
    return Container(
      height: 50.h,
      decoration: BoxDecoration(
  ...
  Widget _buildTextField(AttributeEdit attribute, bool isDark) {
    return Container(
      height: 50.h,
      decoration: BoxDecoration(
        color: AppColors.surface(isDark),
  ...
  Widget _buildBooleanField(AttributeEdit attribute, bool isDark) {
  ...
  Widget _buildBooleanOption(String label, bool optionValue, bool isSelected, AttributeEdit attribute, bool isDark) {
  ...
  Widget _buildOptionsField(AttributeEdit attribute, bool isDark) {
    return Wrap(
      spacing: 12.w,
      runSpacing: 16.h,
  ...
  Widget _buildOptionChip(String label, int value, bool isSelected, AttributeEdit attribute, bool isDark) {
    return ChoiceChip(
      label: Text(
        label,
        style: TextStyle(
